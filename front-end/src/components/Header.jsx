      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-8 py-3">
        <div className="flex items-center">
          <img
            ...
            alt="Logo do Hudson"
          />
          <p className="text-primary-400 text-1 font-bold">udson Viagens</p>
        </div>

        <div className="flex items-center rounded-full border border-gray-400 py-2 pr-3 pl-5 shadow-md">
        ...
        <div>
          <div
            className="flex items-center rounded-full border border-gray-400 py-2 pr-3 pl-3 shadow-md"
            gap-2
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
